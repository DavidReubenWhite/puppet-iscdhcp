  ...
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      context 'with empty subnets hash' do
        ...
        it {
          is_expected.to compile.and_raise_error(%r{parameter 'subnets' expects size to be at least 1.*})
        }
      end
      context 'with incorrect subnets type' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*subnets.*expects.*Hash.*})
        }
      end
      context 'with invalid subnet CIDR' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*subnet.*not a valid V4 CIDR.*})
        }
      end
      ...
      context 'with incorrect enabled services' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*expects a match for Enum.*})
        }
      end
      context 'with incorrect type for enabled services' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*parameter 'enabled_services' expects a value of type Undef or Array.*})
        }
      end
      context 'with incorrect type for freeform_input' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*parameter 'freeform_input' expects a value of type Undef or String.*})
        }
      end
      context 'with incorrect type for global_defaults' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*parameter 'global_defaults' expects a value of type Undef or Hash.*})
        }
      end
      context 'with incorrect type for subnet_defaults' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*expects a value of type Undef or Hash.*})
        }
      end
      context 'with incorrect type for pxe_next_server' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*expects a value of type Undef, Stdlib::Fqdn.*Ipv4.*})
        }
      end
      context 'with incorrect type for pxe_match_criteria' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*expects an undef value or a match for Enum.*})
        }
      end
      ...
      context 'with incorrect type for pxe_arch_to_bootfile_map' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*expects a value of type Undef or Array.*})
        }
      end
      # this needs to be expanded to check if array contains tuple, string etc
      ...
      context 'with incorrect type for pxe_default_bootfile' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*expects a value of type Undef or String.*})
        }
      end
      context 'with incorrect type for omapi_port' do
        ...
        it {
          is_expected.to compile
            .and_raise_error(%r{.*expects a value of type Undef or Integer.*})
        }
      end
